...
<nav className="bg-sky-900 sticky top-0 z-50  px-2 sm:px-4 py-2.5  ">
  ...
  <Link href="/">
              <a>
                <div className="flex flex-row">
                  ...
                  <span 
                    className='flex text-2xl mt-1 text-white ml-2'>
                    USD_VALT
                  </span>
                </div>
              </a>
 ...
 <div className="relative hidden md:block">
    ...
    <button data-collapse-toggle="navbar-search" type="button" className="inline-flex items-center p-2 text-sm text-sky-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-sky-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-search" aria-expanded="false">
