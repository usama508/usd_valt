...
const SearchBar = () => {
    ...
    return (
        <>
            ...
            >
                <div
                    className={`${hide} absolute top-30 mt-1 drop-shadow bg-sky-300 w-96 px-8 py-3 rounded-md`}
                >
                    <table>
                        <div className="  mx-4 my-2  text-xs text-sky-500">
                            <p>Cryptoassets</p>
                        </div>
                        <tbody>
                            {user
                                                    ...
                                                    <a>
                                                        <div className="flex">
                                                            ...
                                                            <div className="">
                                                                ...
                                                                <td className=" bg-sky-300 text-sky-800 justify-end text-xs font-bold mr-2  px-2.5 py-1.5 rounded">
